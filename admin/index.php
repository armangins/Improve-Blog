                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Admin Panel
                            <small>Welcome <?=$_SESSION['username']?></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> General Info
                            </li>
                        </ol>
                    </div>
                </div>
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $total =['Active Posts','comments','Users','Categories'];
          $count = [$totalPosts,$totalcomments,$totalusers,$totalcategories];

          for($x=0;$x<4;$x++){
           echo "['{$total[$x]}'".","."{$count[$x]}],";
          }
          ?>
        ]);
